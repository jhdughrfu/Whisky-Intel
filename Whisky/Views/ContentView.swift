...
struct ContentView: View {
    ...
    @ViewBuilder
    private func bottleRow(for bottle: Bottle) -> some View {
        if bottle.inFlight {
            InFlightBottleView(bottle: bottle)
                .tag(bottle.url)
        } else {
...
struct InFlightBottleView: View {
    let bottle: Bottle
